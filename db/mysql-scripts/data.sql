...
VALUES (@last_id, 'Ben', 'Saunders', '11171', '1048372654', 'Cardiologist');

INSERT INTO app_user(user_role, username, user_password) 
VALUES (1, 'doctor2', 'a8b466a5ddeeb379556f30243d3bcb7377cc621860c3eca95fb18c23de9fefd9');
SET @last_id = last_insert_id();
INSERT INTO doctor(id, firstname, lastname, license_number, phone_number, speciality) 
VALUES (@last_id, 'Elizabeth', 'Combs', '72840', '5920463021', 'Dermatologist');

INSERT INTO app_user(user_role, username, user_password) 
VALUES (1, 'doctor3', '6d958925e445546d1bf3f7580d4d610226b3460918e6c4c029490541803bc7c5');
SET @last_id = last_insert_id();
INSERT INTO doctor(id, firstname, lastname, license_number, phone_number, speciality) 
VALUES (@last_id, 'Mike', 'Grant', '27593', '1048293740', 'Surgeon');
...
-- ADDRESS
INSERT INTO address(country, city, street, post_code) VALUES ('US', 'Los Angeles', 'Grove Street 1', '12-4445');
INSERT INTO address(country, city, street, post_code) VALUES ('US', 'Los Angeles', 'West Street 54a', '59-2594');
INSERT INTO address(country, city, street, post_code) VALUES ('US', 'Los Angeles', 'Castle Street 53', '52-3642');
INSERT INTO address(country, city, street, post_code) VALUES ('US', 'Los Angeles', 'Star Street 122', '98-3525');
...
SET @last_id = last_insert_id();
INSERT INTO patient(id, firstname, lastname, date_of_birth, pesel, gender, phone_number, address_id) 
VALUES (@last_id, 'Fernando', 'Lynn', '2001-05-30', '87198174684', 'male', '4981650481', 3);
...
SET @rand_doctor = (SELECT id FROM doctor ORDER BY RAND() LIMIT 1);
INSERT INTO appointment(appointment_datetime, summary, treatment_plan, patient_id, doctor_id)
VALUES ('2024-06-14 17:30', 'Summary for appointment 3', 'Treatment plan for appointment 3', @rand_patient, @rand_doctor);

SET @rand_patient = (SELECT id FROM patient ORDER BY RAND() LIMIT 1);
SET @rand_doctor = (SELECT id FROM doctor ORDER BY RAND() LIMIT 1);
INSERT INTO appointment(appointment_datetime, summary, treatment_plan, patient_id, doctor_id)
VALUES ('2024-07-14 10:00', 'Summary for appointment 4', 'Treatment plan for appointment 4', @rand_patient, @rand_doctor);

SET @rand_patient = (SELECT id FROM patient ORDER BY RAND() LIMIT 1);
SET @rand_doctor = (SELECT id FROM doctor ORDER BY RAND() LIMIT 1);
INSERT INTO appointment(appointment_datetime, summary, treatment_plan, patient_id, doctor_id)
VALUES ('2024-08-14 12:30', 'Summary for appointment 5', 'Treatment plan for appointment 5', @rand_patient, @rand_doctor);
